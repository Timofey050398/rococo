...
import timofeyqa.rococo.service.api.AllureApiClient;
...
public class AllureResultsDockerExtension implements SuiteExtension {
  ...
  private static final String PROJECT_ID = "timofeyqa-rococo";
  private static final String ALLURE_RESULTS_DIRECTORY = "./rococo-autotest/build/allure-results";
